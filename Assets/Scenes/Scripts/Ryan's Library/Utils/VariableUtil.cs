...
public class Variable<T> : Variable {
	...
	public Listener<T> Connect(Action func) {
		return new Listener<T>((T val) => {
			func.Invoke();
			return true;
		}, this._FuncList, false);
	}

	/// <summary>
	/// Calls every single connected Listeners with own Value as parameter. Useful in edge cases.
	/// </summary>
	public void Call() {
		Call(_Value);
	}
	...
	/// <summary>
	/// Calls every single connected Listeners with this parameter. 
	/// </summary>
