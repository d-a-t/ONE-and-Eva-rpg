...
[CustomPropertyDrawer(typeof(AudioClipDict))]
public class AudioClipDictDrawer : DictionaryDrawer<string, AudioClip> { }

[CustomPropertyDrawer(typeof(AudioSourceDict))]
public class AudioSourceDictDrawer : DictionaryDrawer<string, AudioSource> { }